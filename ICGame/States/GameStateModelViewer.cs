...
namespace VertexArmy.States
{
	class GameStateModelViewer : IGameState
	{
		...
		public void OnEnter()
		{
			...
			GlobalMatrix.Instance.LoadMatrix( EMatrix.View, Matrix.CreateLookAt( new Vector3( 0, 0, -240 ), new Vector3( 0, 0, 0 ), new Vector3( 0, 1, 0 ) ) );


			_scene = new Scene { Eye = new Vector3(0, 0, 0), Light = new Vector3(0, 5000, 0) };
			_node = new RobotSceneNode( );
			_node.LoadNode( _cm, "sphere" );
