...
VertexShaderOutput main_VS(VertexShaderInput input)
{
	...
	output.Texcoord.xy = input.Texcoord * float2(0.125, 0.25); // * float2 ( length (float3(matWorld[0][0], matWorld[1][0], matWorld[2][0])),
											//	   length (float3(matWorld[0][1], matWorld[1][1], matWorld[2][1])) ) / 20;
